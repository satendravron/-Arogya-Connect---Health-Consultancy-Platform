...
```bash
git config --global user.name "satendravron"
...
git clone [https://github.com/satendravron/Arogya-Connect](https://github.com/satendravron/Arogya-Connect)
...
Update the MongoDB connection URL in the backend configuration file (config.js).
